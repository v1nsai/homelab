...
kubectl create secret generic wordpress-password \
    ...
    --dry-run=client \
    --output yaml | \
kubeseal --format yaml --cert ./.sealed-secrets.pub > projects/personal-site/app/sealed-secrets.yaml
...
kubectl create secret generic externaldb-password \
    ...
    --dry-run=client \
    --output yaml | \
kubeseal --format yaml --cert ./.sealed-secrets.pub | tee -a projects/personal-site/app/sealed-secrets.yaml
